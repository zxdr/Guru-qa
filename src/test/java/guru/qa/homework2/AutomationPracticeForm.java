...
public class AutomationPracticeForm {
    ...
    void successfulSubmitFormTest() {
        ...
        //Junit option
        assertEquals(String.format("<td>%s %s</td>", firstName, lastName),
                $x("//td[text()='Student Name']/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", userEmail), $x("//td[text()='Student Email']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", gender3), $x("//td[text()='Gender']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", userNumber), $x("//td[text()='Mobile']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", dateOfBirth), $x("//td[text()='Date of Birth']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", subject), $x("//td[text()='Subjects']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s, %s, %s</td>", hobby1, hobby2, hobby3),
                $x("//td[text()='Hobbies']/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", picture), $x("//td[text()='Picture']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s</td>", address), $x("//td[text()='Address']"
                + "/following-sibling::td").toString());
        assertEquals(String.format("<td>%s %s</td>", state, city), $x("//td[text()='State and City']"
                + "/following-sibling::td").toString());
